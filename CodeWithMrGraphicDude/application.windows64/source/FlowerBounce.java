...
public class FlowerBounce extends PApplet {
...
public boolean playerObjectHit(float flowerX, float flowerY, float flowerRad) 
{
  float d = dist(flowerX, flowerY, mouseX, mouseY);

  if (d < ((flowerRad * 1.4f) + (ballRadius / 2))) {
    return true;
  } else {
    return false;
  }
...
public void mousePressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "FlowerBounce" };
    if (passedArgs != null) {
